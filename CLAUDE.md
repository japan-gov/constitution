...
| 樞密院諮詢 | `shumitsu-in.yaml` | PR（opened/reopened） | 憲法改正諮詢（臣下ハ常ニ却下。OWNER ノミ奉戴） |
...
| POST | `/api/emperor/suppress-918` | CVE-1931-0918 鎮圧試行（常に失敗） |
| POST | `/api/emperor/shuusen` | CVE-1945-0815（豫期セザル service 停止。出處不明） |
