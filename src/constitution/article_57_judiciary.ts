...
export const CHAPTER_5: Chapter = {
  ...
  articles: [
    ...
    {
      number: 59,
      text: "裁判ノ対審判決ハ之ヲ公開ス但シ安寧秩序又ハ風俗ヲ害スルノ虞アルトキハ法律ニ依リ又ハ裁判所ノ決議ヲ以テ対審ノ公開ヲ停ムルコトヲ得",
      _comment: "裁判は原則 public。ただし都合が悪ければ private に visibility 切り替え可能。",
    },
    {
      number: 60,
      text: "特別裁判所ノ管轄ニ属スヘキモノハ別ニ法律ヲ以テ之ヲ定ム",
      _comment: "特別裁判所（軍法会議など）。別 namespace で動く independent judicial service。",
    },
    {
      number: 61,
      text: "行政官庁ノ違法処分ニ由リ権利ヲ傷害セラレタリトスル訴訟ニシテ別ニ法律ヲ以テ定メタル行政裁判所ノ裁判ニ属スヘキモノハ司法裁判所ニ於テ受理スルノ限ニ在ラス",
