...
export const CHAPTER_2: Chapter = {
  ...
  articles: [
    ...
    {
      number: 19,
      text: "日本臣民ハ法律命令ノ定ムル所ノ資格ニ応シ均ク文武官ニ任セラレ及其ノ他ノ公務ニ就クコトヲ得",
      _comment: "採用要件を満たせば公務員になれる…はず。実際は身分・性別・思想で filter にかけられる。",
    },
    {
      number: 20,
      text: "日本臣民ハ法律ノ定ムル所ニ従ヒ兵役ノ義務ヲ有ス",
